...
public class TestPolyLine {
    ...
    public void testPoints(){
        ...
        PolyLine polyLine = new PolyLine(points);
        polyLine.setFirstPoint(new Point(5,5));
        polyLine.setSecondPoint(1,1);
        assertAll(
                ()-> assertEquals(5,polyLine.getFirstPoint().getX()),
                ()->assertEquals(5, polyLine.getFirstPoint().getY()),
                ()->assertEquals(1, polyLine.getSecondPoint().getX()),
                ()->assertEquals(1, polyLine.getSecondPoint().getY())
        );
    }
