...
public class TestCircle {
    ...
    public void testPoints(){
        ...
        circle.setFirstPoint(new Point(2,2));
        assertAll(
                ()->assertEquals(2,circle.getFirstPoint().getX()),
                ()->assertEquals(2,circle.getFirstPoint().getY())
        );
        circle.setSecondPoint(5,6);
        assertAll(
                ()->assertEquals(5,circle.getSecondPoint().getX()),
                ()->assertEquals(6,circle.getSecondPoint().getY())
        );
    }
}
